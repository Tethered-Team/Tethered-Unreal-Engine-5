...
void ATetheredCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		UE_LOG(LogTethered, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}
...
void ATetheredCharacter::DoMove(float Right, float Forward)
{
...
void ATetheredCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ATetheredCharacter::DoJumpEnd()
{
